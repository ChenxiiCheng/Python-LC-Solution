...
![image-20190810002050671](/Users/chenxi/Library/Application Support/typora-user-images/image-20190810002050671.png)
...
class Solution:
    def countNodes(self, root: TreeNode) -> int:
        #Solution
        #求完全二叉树的节点数目。注意完全二叉树和满二叉树Full Binary Tree的唯一区别是，
        #完全二叉树最后一层的节点不满，而且假设最后一层有节点，都是从左边开始。 这样我们可以利用这个性质得到下面的结论：
